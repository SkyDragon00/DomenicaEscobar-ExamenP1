...
namespace DomenicaEscobar_ExamenP1.Controllers
{
    public class DomenicaEscobar_TablaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DENombre,DEPrecio,DEConTocino,DEFecha")] DomenicaEscobar_Tabla domenicaEscobar_Tabla)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DENombre,DEPrecio,DEConTocino,DEFecha")] DomenicaEscobar_Tabla domenicaEscobar_Tabla)
        {
